    ...
    public static class DataSeeder
    {
        ...
        public static void Seed(this ModelBuilder modelbuilder)
        {
            ...
            modelbuilder.Entity<Course>().HasData(
                ...
                new Course { AvailableSpots = 4, CourseId = 3, StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(90), StudyPace = 100, ImageSrc= "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/1280px-React-icon.svg.png", Subject = "React", CourseInfo = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Posuere urna nec tincidunt praesent semper feugiat nibh sed." },
                new Course { AvailableSpots = 4, CourseId = 4, StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(90), StudyPace = 100, ImageSrc= "https://upload.wikimedia.org/wikipedia/commons/4/49/Redux.png", Subject = "Redux", CourseInfo= "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Posuere urna nec tincidunt praesent semper feugiat nibh sed." }
                );
