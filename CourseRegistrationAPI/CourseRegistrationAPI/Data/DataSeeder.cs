    ...
    public static class DataSeeder
    {
        ...
        public static void Seed(this ModelBuilder modelbuilder)
        {
            ...
            modelbuilder.Entity<Course>().HasData(
                new Course { AvailableSpots=2, CourseId = 1, StartDate = DateTime.Now, EndDate = DateTime.Now.AddDays(90), StudyPace = 100, ImageSrc= "https://i1.wp.com/www.hyrobygg.se/wp-content/uploads/2016/03/js-logo.png?fit=500%2C500&ssl=1", Subject = "Javascript", CourseInfo = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Posuere urna nec tincidunt praesent semper feugiat nibh sed." },
                new Course { AvailableSpots = 3, CourseId = 2, StartDate = DateTime.Now.AddDays(30), EndDate = DateTime.Now.AddDays(120), StudyPace = 100, ImageSrc= "https://cdn.pixabay.com/photo/2017/08/05/11/16/logo-2582748_640.png", Subject = "HTML", CourseInfo = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Posuere urna nec tincidunt praesent semper feugiat nibh sed." },
                new Course { AvailableSpots = 4, CourseId = 3, StartDate = DateTime.Now.AddDays(-30), EndDate = DateTime.Now.AddDays(60), StudyPace = 100, ImageSrc= "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/1280px-React-icon.svg.png", Subject = "React", CourseInfo = "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Posuere urna nec tincidunt praesent semper feugiat nibh sed." },
                new Course { AvailableSpots = 4, CourseId = 4, StartDate = DateTime.Now.AddDays(-90), EndDate = DateTime.Now.AddDays(0), StudyPace = 100, ImageSrc= "https://upload.wikimedia.org/wikipedia/commons/4/49/Redux.png", Subject = "Redux", CourseInfo= "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Posuere urna nec tincidunt praesent semper feugiat nibh sed." }
                );
